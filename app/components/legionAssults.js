import template from './legionAssults.html';
import { assultsApi as ASSULTS_API } from '../config';

export const NAME = 'legionAssults';

class LegionAssultsCtrl {
